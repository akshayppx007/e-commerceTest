...
import loginUserMutation from "../../actions/user/loginUser";
...
const Login = () => {
  ...
  const { mutate: login, isPending: loginPending } = loginUserMutation();
  const { data, refetch, isLoading } = getLoginUserQuery();
